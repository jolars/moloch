...
\begin{abstract}
  ...
  Quarto-based documentation system that we use to generate both \PDF\ and \HTML\
  documentation.
\end{abstract}
...
presentations in addition to providing useful features such as progress bars
and (what we think are) sane defaults for presentations.
