...
\begin{abstract}
  \titleref{Moloch} is a fork of the popular \LaTeX\
  \titleref{beamer}~\cite{wright:2025} theme \titleref{Metropolis}, which is no
  longer actively maintained. Moloch aims to fix outstanding issues with
  \titleref{Metropolis} while keeping the original design mostly intact. This
  article summarizes the changes made in \titleref{Moloch} as well as some
  general \TUB\ style guidelines for authors.
\end{abstract}

\section{Introduction}

I have long been an admirer and user of the excellent Metropolis theme, which
provides a clean, professional look for \LaTeX\ \titleref{beamer} presentations
in addition to enabling useful features such as progress bars and (what I think
