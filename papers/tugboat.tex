...
and the \LaTeX\ kernel, these modifications became brittle. Over time a number
of issues have cropped up. Most of the issues are minor and corrigible through
workarounds, but our preambles have grown increasingly cluttered with such
patches. Moreover, a number of users have requested features, while others have
offered contributions to help improve the theme. \texttt{Metropolis} being
