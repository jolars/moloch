...
up. Most of these are minor and corrigible through workarounds, but were
causing users' preambles to grow increasingly cluttered with such patches. Some
users have also requested features, while others have offered contributions to
help improve the theme. \texttt{Metropolis} being unmaintained, however, these
requests and contributions have gone unaddressed.
...
internal code to make the theme robust and maintainable going forward. Users of
