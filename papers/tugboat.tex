...
Unlike most other packages, however, \texttt{Moloch} also comes with a HTML
...
the same vein as the unofficial HTML documentation for
...
provide a single source of truth for both the \acro{PDF} and HTML
documentation.
