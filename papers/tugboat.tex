...
\begin{figure}[htb]
  \centering
  \frame{\includegraphics[width=0.49\columnwidth]{moloch-blocks}}\hfill
  \frame{\includegraphics[width=0.49\columnwidth]{metropolis-blocks}}

  \caption{%
    A comparison of block environments in Moloch (left) and Metropolis }
  \label{fig:block-comparison}
\end{figure}

\subsection{Other Miscellaneous Changes}

We will not go into further details here, but other changes include
\begin{itemize}
  \item Redesigned default title page style
  \item The build system has been modernized to use
        \texttt{l3build}~\cite{mittelbach:2014} and now includes unit tests
  \item Bibliography style is no longer hardcoded
\end{itemize}
