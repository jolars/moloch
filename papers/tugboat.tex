...
in similar fashion as the unofficial documentation for \texttt{PGF}/\texttt{TikZ}
at \url{https://tikz.dev}. Yet, whereas that site is generated via
...
\begin{figure}[htpb]
  ...
  \caption{%
    The same documentation block rendered in \LaTeX\ (top) and \HTML\
    (bottom) via a custom \texttt{Quarto} filter.
  }
  \label{fig:describe-option}
\end{figure}
